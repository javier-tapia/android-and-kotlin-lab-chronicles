...
object HiltLabConfigModule {
    /**
     * Provee la instancia única y centralizada para la interfaz [HiltLabConfigurator].
     *
     ...
     * [HiltLabConfigurator]. Dado que las interfaces no tienen constructor inyectable (`@Inject`), este método
     * le indica explícitamente a Hilt qué implementación concreta instanciar ([CoreHiltLabConfigurator]).
     ...
     * @return Una implementación singleton de [HiltLabConfigurator] parametrizada según el entorno de ejecución.
     */
    @Provides
    @Singleton
    fun provideLabConfigurator(
        ...
        return CoreHiltLabConfigurator(isDebug = isDebuggable)
    }
}
